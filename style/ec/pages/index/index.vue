<template>
	<view class="container">
		<!-- 小程序头部兼容 -->
		<!-- #ifdef MP -->
		<view class="mp-search-box" v-if="true">
		...
		<!-- 分类 -->
		<view class="cate-section" v-if="true">
		...
		<view class="ad-1" v-if="true">
			<image src="/static/temp/ad1.jpg" mode="scaleToFill"></image>
		</view>
		
		<!-- 秒杀楼层 -->
		<view class="seckill-section m-t" v-if="true">
			<view class="s-header">
		...
		<!-- 团购楼层 -->
		<view class="f-header m-t" v-if="true">
		...
		<view class="group-section" v-if="true">
		...
		<view class="hot-floor" v-if="true">
		...
		<view class="guess-section" v-if="true">
			<view 
				v-for="(item, index) in goodsList" :key="index"
				class="guess-item"
				@click="navToDetailPage(item)"
	...
	export default {
		...
		methods: {
			...
			navToDetailPage(item) {
				...
				let id = item.title;
				uni.navigateTo({
					url: `/style/ec/pages/product/product?id=${id}`
				})
			},
		},
		// #ifndef MP
